...
imenb_path="/media/durasan/YT1/yt2018/%(id)s_%(title)s_%(playlist_id)s_%(playlist_title)s_%(upload_date)s_%(height)s_%(abr)s_%(format_id)s.%(ext)s"
...
if channel_flag:
        ...
        out_csv="/media/durasan/YT1/yt2018/%(playlist_id)s_%(playlist_title)s.csv"
