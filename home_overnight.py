...
winpath="M:\yt2018\test\%(id)s_%(title)s_%(playlist_id)s_%(playlist_title)s_%(upload_date)s_%(height)s_%(abr)s_%(format_id)s.%(ext)s"
...
if channel_flag:
        ...
        pl_id=info_dict['entries'][0]['playlist_id']
